...
if [ 0"$XMLY_SPEED_COOKIE" = "0" ]; then
    ...
    wget -O /xmly_speed/util.py https://pd.zwc365.com/https://raw.githubusercontent.com/whyour/hundun/master/quanx/util.py
    wget -O /xmly_speed/xmly_speed.py https://pd.zwc365.com/https://raw.githubusercontent.com/whyour/hundun/master/quanx/xmly_speed.py
...
if [ 0"$HOTSOONSIGNHEADER" = "0" ]; then
    ...
    wget -O /hotsoon/Scripts/sendNotify.js https://pd.zwc365.com/https://raw.githubusercontent.com/Ariszy/script/master/sendNotify.js
...
if [ 0"$DDAYD_ddaydCK" = "0" ]; then
    ...
    wget -O /ZIYE_JavaScript/Task/ddayd.js https://pd.zwc365.com/https://raw.githubusercontent.com/Aaron-lv/sync/2a9d66a462c0a150768bd18936fb083dab79d1b6/Task/ddayd.js
